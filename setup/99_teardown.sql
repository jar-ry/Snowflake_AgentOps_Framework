...
DROP TASK IF EXISTS {{FRAMEWORK_DB}}.{{FRAMEWORK_SCHEMA}}.TASK_LLM_FEEDBACK_SCORING;
DROP TASK IF EXISTS {{FRAMEWORK_DB}}.{{FRAMEWORK_SCHEMA}}.TASK_WEEKLY_EVALUATION;
...
DROP TABLE IF EXISTS {{FRAMEWORK_DB}}.{{FRAMEWORK_SCHEMA}}.EVAL_SCHEDULE_CONFIG;

-- ============================================================================
-- STAGES / FILE FORMATS
-- ============================================================================

DROP STAGE IF EXISTS {{FRAMEWORK_DB}}.{{FRAMEWORK_SCHEMA}}.EVAL_CONFIG_STAGE;
DROP FILE FORMAT IF EXISTS {{FRAMEWORK_DB}}.{{FRAMEWORK_SCHEMA}}.FF_EVAL_CONFIG_YAML;
