...
- [Choose which modules to install](how-to/choose-modules.md) — deploy only the capabilities you need (dashboard-only, monitoring-only, no CI/CD, etc.) via the modular installer.
